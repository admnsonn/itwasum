      ...
      <div className="flex items-start justify-between gap-3">
        <div className="flex items-center gap-2.5 min-w-0">
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <span className={`px-2 py-0.5 rounded border text-[9px] font-black uppercase tracking-wider ${atensiInfo?.badgeBg || 'bg-slate-100 text-slate-700 border-slate-200'} ${atensiInfo?.badgeText || 'text-slate-700'} ${atensiInfo?.badgeBorder || 'border-slate-200'}`}>
                {atensiInfo?.statusAtensiShort || conditionTheme?.badgeText || 'Status'}
              </span>
