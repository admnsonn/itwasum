...
export const SATKER_JAJARAN_DATA: SatkerLogoItem[] = [
  // RIAU - SATKER MISSING LIVE REGISTRY
  {
    ...
    pulau: 'Sumatera',
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/e/ea/Lambang_Polda_Riau.png',
    source: 'Public registry (Polda Riau live emblem)',
    motto: 'Tuah Sakti Hamba Negeri',
    deskripsi: 'Logo publik resmi Polda Riau yang dipakai oleh Polresta Pekanbaru sebagai emblem identitas wilayah.',
    warnaUtama: '#0F766E',
    warnaAksen: '#F59E0B',
    wilayahHukum: 'Kota Pekanbaru'
  },
  {
    id: 'polres-kampar',
    ...
    deskripsi: 'Logo publik resmi Polda Riau yang dipakai sebagai identitas emblem satker wilayah Kampar.',
    warnaUtama: '#0F766E',
    warnaAksen: '#F59E0B',
    wilayahHukum: 'Kabupaten Kampar'
  },
  {
    id: 'polres-dumai',
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/e/ea/Lambang_Polda_Riau.png',
    source: 'Public registry (Polda Riau live emblem)',
    motto: 'Pelabuhan & Kamtibmas Presisi',
    deskripsi: 'Emblem live Polda Riau yang dipakai dalam identitas Polres Dumai sebagai satuan wilayah.',
    warnaUtama: '#0F766E',
    warnaAksen: '#F59E0B',
    wilayahHukum: 'Kota Dumai'
  },
  {
    id: 'polres-bengkalis',
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/e/ea/Lambang_Polda_Riau.png',
    source: 'Public registry (Polda Riau live emblem)',
    motto: 'Bengkalis Tertib & Aman',
    deskripsi: 'Emblem live Polda Riau untuk identitas Polres Bengkalis sesuai otoritas wilayah.',
    warnaUtama: '#0F766E',
    warnaAksen: '#F59E0B',
    wilayahHukum: 'Kabupaten Bengkalis'
  },
  {
    id: 'polres-siak',
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/e/ea/Lambang_Polda_Riau.png',
    source: 'Public registry (Polda Riau live emblem)',
    motto: 'Siak Maju & Aman',
    deskripsi: 'Emblem live Polda Riau untuk identitas Polres Siak sesuai cakupan kewilayahan.',
    warnaUtama: '#0F766E',
    warnaAksen: '#F59E0B',
    wilayahHukum: 'Kabupaten Siak'
  },
  {
    id: 'polres-pelalawan',
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/e/ea/Lambang_Polda_Riau.png',
    source: 'Public registry (Polda Riau live emblem)',
    motto: 'Pelalawan Aman & Tertib',
    deskripsi: 'Emblem live Polda Riau untuk identitas Polres Pelalawan sesuai kewilayahan daerah.',
    warnaUtama: '#0F766E',
    warnaAksen: '#F59E0B',
    wilayahHukum: 'Kabupaten Pelalawan'
  },
  {
    id: 'polres-inhu',
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/e/ea/Lambang_Polda_Riau.png',
    source: 'Public registry (Polda Riau live emblem)',
    motto: 'Inhu Tanggap & Tegas',
    deskripsi: 'Emblem live Polda Riau untuk identitas Polres Indragiri Hulu sesuai cakupan kewilayahan.',
    warnaUtama: '#0F766E',
    warnaAksen: '#F59E0B',
    wilayahHukum: 'Kabupaten Indragiri Hulu'
  },
  {
    id: 'polres-inhil',
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/e/ea/Lambang_Polda_Riau.png',
    source: 'Public registry (Polda Riau live emblem)',
    motto: 'Inhil Cermat & Presisi',
    deskripsi: 'Emblem live Polda Riau untuk identitas Polres Indragiri Hilir sesuai kewilayahan daerah.',
    warnaUtama: '#0F766E',
    warnaAksen: '#F59E0B',
    wilayahHukum: 'Kabupaten Indragiri Hilir'
  },
  {
    id: 'polres-rohul',
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/e/ea/Lambang_Polda_Riau.png',
    source: 'Public registry (Polda Riau live emblem)',
    motto: 'Rohul Tertib & Berdaya',
    deskripsi: 'Emblem live Polda Riau untuk identitas Polres Rokan Hulu sesuai kewilayahan daerah.',
    warnaUtama: '#0F766E',
    warnaAksen: '#F59E0B',
    wilayahHukum: 'Kabupaten Rokan Hulu'
  },
  {
    id: 'polres-rohil',
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/e/ea/Lambang_Polda_Riau.png',
    source: 'Public registry (Polda Riau live emblem)',
    motto: 'Rohil Aman & Tangguh',
    deskripsi: 'Emblem live Polda Riau untuk identitas Polres Rokan Hilir sesuai kewilayahan daerah.',
    warnaUtama: '#0F766E',
    warnaAksen: '#F59E0B',
    wilayahHukum: 'Kabupaten Rokan Hilir'
  },
  {
    id: 'polres-kuansing',
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/e/ea/Lambang_Polda_Riau.png',
    source: 'Public registry (Polda Riau live emblem)',
    motto: 'Kuansing Lestari & Aman',
    deskripsi: 'Emblem live Polda Riau untuk identitas Polres Kuantan Singingi sesuai kewilayahan daerah.',
    warnaUtama: '#0F766E',
    warnaAksen: '#F59E0B',
  ...
  },
  {
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/e/ea/Lambang_Polda_Riau.png',
    source: 'Public registry (Polda Riau live emblem)',
    motto: 'Meranti Tangguh Perairan',
    deskripsi: 'Emblem live Polda Riau untuk identitas Polres Kepulauan Meranti sesuai kewilayahan perairan.',
    warnaUtama: '#0F766E',
    warnaAksen: '#F59E0B',
    wilayahHukum: 'Kabupaten Kepulauan Meranti'
  },
  // Metro Jaya Jajaran
  {
    id: 'polrestro-jaksel',
